...
public class Challenge6 {
    ...
    public static void registerCommandStudentA(String command) {
        switch (command.toUpperCase()) {
            case "GREET" -> commandsStudentA.put("GREET", () -> System.out.println("Greetings, traveler of time and code!"));
            case "FAREWELL" -> commandsStudentA.put("FAREWELL", () -> System.out.println("May the bits be with you until the next mission."));
